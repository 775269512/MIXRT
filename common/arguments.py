...
def get_common_args():
    ...
    # The alternative algorithms are irtc, commtree
    parser.add_argument('--alg', type=str, default='commtree', help='the algorithm to train the agent')
    ...
    parser.add_argument('--load_model_num', type=int, default=8, help='which model is loaded')
    parser.add_argument('--evaluate', type=bool, default=False, help='whether to evaluate the model')
    parser.add_argument('--cuda', type=bool, default=False, help='whether to use the GPU')
    parser.add_argument('--q_tree_depth', type=int, default=0, help='q_tree_depth')
...
# arguments of vnd, qmix, qtran, sdt, commtree
def get_mixer_args(args):
    ...
    # Tree
    if args.alg == 'commtree' or args.alg == 'isdt' or args.alg == 'irtc' or args.alg == 'icdt':
        args.is_tree = True
        args.rnn_hidden_dim = args.rnn_tree_dim
        args.qmix_hidden_dim = args.qmix_tree_dim
        args.q_tree_depth = 3 if args.q_tree_depth==0 else args.q_tree_depth
        args.mix_q_tree_depth = 3 if args.mix_q_tree_depth==0 else args.mix_q_tree_depth
        args.agent_comm = False
        args.beta = 0
